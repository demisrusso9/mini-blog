...
export type EditPostFormFieldsProps = z.infer<typeof postSchema>

interface EditPostFormProps {
	post: IPost
	handleSubmitForm(data: EditPostFormFieldsProps): void
}
...
export function EditPostForm({ post, handleSubmitForm }: EditPostFormProps) {
	const {
		handleSubmit,
		register,
		formState: { errors }
